...
public class RunQueryCountTriples extends SparqlQuerier{
	
	public RunQueryCountTriples(Triplestore r, String endpoint) {
		super(r, endpoint);
	}
	...
	public boolean fact(QuerySolution qs) throws InterruptedException {		
		if(qs.getLiteral("count")==null)
			return false;
		StaticalEvaluation.cTriples += qs.getLiteral("count").getInt();
