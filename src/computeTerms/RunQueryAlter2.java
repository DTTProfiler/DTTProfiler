...
public class RunQueryAlter2 extends SparqlQuerier{
	
	public RunQueryAlter2(Triplestore r, String endpoint) {
		super(r, endpoint);
	}
	...
	public boolean fact(QuerySolution qs) throws InterruptedException {		
		...
		//resObj = resObj.replaceAll("https://ark.frantiq.fr/ark:/26678/", "");
		//System.out.println(resObj);
		resObj = Build.getNameFromURI(resObj);
